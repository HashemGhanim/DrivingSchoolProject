...
function SignUpStudent(props) {
    ...
    const handleSubmit = (e)=>{
        ...
        if(student.password === student.repeatedPassword){

            if(student.gender){

                if(student.phone){
                    axios.post('http://localhost:8000/user' , student , {
                        headers:{
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Hello... ',
                            text: 'User is Created , Welcome ' + student.firstName
                        });
                        console.log(res);
                    }).catch((err)=>{
                        setIsErr(true);
                                ...
                                <div className="card-body p-5">
                                    ...
                                    <form method="post" onSubmit={handleSubmit}>
                                        <div className="form-outline mb-4 row-12 ">
                                            ...
                                            <input style={{display: "inline-block", width: "45%"}}  placeholder={"Student ID"}
                                        ...
                                        {isErr && <div className="text-center text-danger fs-4">
                                            User not registered
                                            <p className="fs-5">please check your inputs</p>
                                        </div>}
